...
func (vp *valuesProvider) GetControlPlaneShootChartValues(
	...
	var cloudProviderDiskConfig string
	...
	return getControlPlaneShootChartValues(infraStatus, k8sVersionLessThan118, checksums, cloudProviderDiskConfig), nil
}
